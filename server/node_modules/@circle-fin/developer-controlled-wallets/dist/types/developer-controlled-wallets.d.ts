...
import { TokenBlockchain, Blockchain, EstimateContractExecutionTransactionFeeRequestBlockchain, Operation, ListTransactionsStateEnum, TransactionType, FeeLevel, WalletMetadata, AccountType } from './clients/developer-controlled-wallets';
export { AccountType, Balance, Blockchain, CustodyType, EstimateContractExecutionTransactionFeeRequestBlockchain, FeeLevel, GetTransactionTxTypeEnum, ListTransactionsOperationEnum, ListTransactionsStateEnum, ListTransactionsTxTypeEnum, ListWalletBallanceStandardEnum, ListWalletNftsStandardEnum, Operation, TokenBlockchain, TokenStandard, TransactionState, TransactionType, WalletState } from './clients/developer-controlled-wallets';
import * as _shared_core from './clients/core';
import { ClientParams as ClientParams$1, Pagination, FeeConfiguration, WithIdempotencyKey } from './clients/core';
...
declare function initiateDeveloperControlledWalletsClient({ apiKey, baseUrl, entitySecret, storage, userAgent, headers, }: ClientParams): {
     ...
     * ```
     */
    createWalletSet: ({ idempotencyKey, name }: CreateWalletSetInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.WalletSet2>>;
    /**
     ...
     * ```
     */
    getWalletSet: ({ id }: GetWalletSetInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.WalletSet2>>;
    /**
     ...
     * ```
     */
    updateWalletSet: ({ id, name }: UpdateWalletSetInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.WalletSet2>>;
    /**
     ...
     * ```
     */
    getWallet: ({ id }: GetWalletInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.Wallet2>>;
    /**
     ...
     * ```
     */
    updateWallet: ({ id, name, refId }: UpdateWalletInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.Wallet2>>;
    /**
     ...
     * ```
     */
    getWalletTokenBalance: ({ id, includeAll, name, pageAfter, pageBefore, pageSize, tokenAddresses, standard, }: GetWalletTokenBalanceInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.ListWalletBallance200Response>>;
    /**
     * Fetch the balance of digital assets for a specific wallet using its unique identifier.
     * @example
     * ```
     ...
     * ```
     */
    getWalletNFTBalance: ({ id, includeAll, name, pageAfter, pageBefore, pageSize, tokenAddresses, standard, }: GetWalletNFTBalanceInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.ListWalletNfts200Response>>;
    /**
     ...
     * ```
     */
    createContractExecutionTransaction: ({ idempotencyKey, fee, ...input }: CreateContractExecutionTransactionInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.CreateDeveloperTransactionContractExecution200Response>>;
    /**
     ...
     * ```
     */
    estimateContractExecutionFee: ({ source, ...input }: EstimateContractExecutionFeeInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.CreateTransferEstimateFee200Response>>;
    /**
